...
export function NoAgentNotification(props: NoAgentNotificationProps) {
  ...
  const bgColor = useColorModeValue("gray.800", "#1F1F1F");
  const warningIconColor = useColorModeValue("gray.500", "#666666");
  const closeIconColor = useColorModeValue("gray.500", "#999999");
