      ...
      {showNotification ? (
        <div
          className="fixed top-6 left-1/2 transform -translate-x-1/2 \
                     ...
                     px-4 py-3 \
                     text-sm rounded-lg \
                     bg-gray-800 dark:bg-[#1F1F1F] text-white \
                     shadow-lg"
        >
          <div>
            <svg
            ...
            >
              <path
                ...
                className="fill-gray-400 dark:fill-[#666666]"
              />
            </svg>
          </div>
          <p className="max-w-fit text-gray-200 dark:text-gray-300">
          ...
          <button
            ...
            className="p-1 rounded-md text-gray-400 dark:text-[#999999] hover:bg-gray-700 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 dark:focus:ring-offset-[#1F1F1F] focus:ring-white"
          >
            <CloseIcon />
          </button>
        </div>
